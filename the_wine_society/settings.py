"""
Django settings for the_wine_society project.
...
ROOT_URLCONF = 'the_wine_society.urls'
...
WSGI_APPLICATION = 'the_wine_society.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'the-wine-society'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'thewinesociety@example.com'
else:
    EMAIL_BACKEND = 'django.core.mail.backends.stmpo.EmailBackend'
    EMAIL_USE_TLS = True
    EMAIL_PORT = 587
