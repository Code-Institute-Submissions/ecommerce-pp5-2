...
class Order(models.Model):
    ...
    phone_number = models.CharField(max_length=20, null=False, blank=False, default='Phone Number')
    ...
    county_or_state = models.CharField(max_length=50, null=False, blank=False)
    ...
    def _generate_order_number(self):
        """
        Generate a unique randmm order number
        """
